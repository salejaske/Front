  ...
  private putCategoriesInState(data?: ApiCategoryDto[]){
                ...
                <Modal size="lg" centered show={ this.state.addModal.visible } 
                    ...
                    <Modal.Body>
                        <Form.Group>
                          ...
                          <Form.Control id="add-categoryId" type="select" value={ this.state.addModal.categoryId.toString() }
                        ...
                        <Form.Group>
                          <Button variant="primary" onClick={() => this.doAddArticle() }> 
                            <FontAwesomeIcon icon={faPlus} />Add new article</Button>
                        </Form.Group>
                 ...
                 <Modal size="lg" centered show={ this.state.editModal.visible } 
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group>
                          ...
                          <Form.Control id="edit-status" type="select" value={ this.state.editModal.status.toString() }
                        ...
                        <Form.Group>
                          <Button variant="primary" onClick={() => this.doEditArticle() }> 
                            <FontAwesomeIcon icon={faSave} />Edit article</Button>
                        </Form.Group>
    ...
    private doAddArticle(){
      ...
      if (filePicker?.files.length === 0){
           this.setAddModalStringFieldState('message', 'You must select a file!');
            return;
      }
